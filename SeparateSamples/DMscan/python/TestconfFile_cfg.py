...
import SeparateSamples.DMscan.toload_cff
...
#process.maxLuminosityBlocks = cms.untracked.PSet( 
 #              input = cms.untracked.int32(1)
  #  )
#process.numberEventsInLuminosityBlock = cms.untracked.uint32(1)
#cms.untracked.PSet(
#                input = cms.untracked.int32(1)
#  )                        
process.extend(SeparateSamples.DMscan.toload_cff)
...
#### This shall produce  our intermediate step .txt files,
